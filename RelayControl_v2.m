...
%%        
        for iteracion=1:1:iteracciones
                ...
                [pos_vehX_Rx]=UbicacionNodos_TxRx(pos_vehX_xini_Rx,pos_vehX_xend_Rx,width_x,Veh_x_Rx); 
 ...
 %%        
            ...
            %%% for RLosx=1:1:VehiculosRx  
                 [pRLosx]=find(zona_vehX==(max(zona_vehX(:,1))));    
                 RLosx=max(pRLosx);
              ...
              %%% end RELAY LOS
               ...
               for NCRLosy=1:2:VehiculosTx-1
                 ...
                 %%%   for NCRLosx=1:1:VehiculosRx 
                         ...
                         [NCpRLosx]=find(zona_vehX==(max(zona_vehX(:,1))));    
                         NCRLosx=max(NCpRLosx);
